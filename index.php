...
<section id="prizes" style="background-color: #0f172a; color: white; padding: 60px 20px; min-height: 100vh; text-align: center;">
  ...
  <div  style="display: flex; flex-direction: column; gap: 20px; max-width: 1000px; margin: 0 auto; font-family: sans-serif;">
    ...
    <div style="background: #1a1a1a; border: 2px solid #3b82f6; border-radius: 15px; padding: 30px; width: 100%; box-sizing: border-box;box-shadow: 5px 5px 12px lightblue;">
    ...
    <div style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center;">
      ...
      <div style="flex: 1; min-width: 280px; background: #1a1a1a; border: 2px solid #3b82f6; border-radius: 15px; padding: 30px;box-shadow: 4px 5px 12px lightblue;">
      ...
      <div style="flex: 1; min-width: 280px; background: #1a1a1a; border: 2px solid #3b82f6; border-radius: 15px; padding: 30px; box-shadow: 5px 5px 12px lightblue;">
        <div style="font-size: 40px;">🥉</div>
